...
Dette kapitel vil vise, hvordan man anvender den før redegjort for teori på trigonometriske funktioner og til at tilnærme sig $\pi$. 
%Målet er at vise, hvordan man numerisk kan udregne værdier for $\sin(x)$, $\cos(x)$ og $\tan(x)$, samt hvordan man kan anvende enhedscirklen og Taylorpolynomier til at finde en approksimation $\pi$.
...
\begin{align*}
T_{\sin} (x) &= 0+x+0 \cdot \frac{x^2}{2}-\frac{x^3}{3!}+0 \cdot \frac{x^4}{4!}+\frac{x^5}{5!}+\cdots 
\\
T_{\sin} (x) &= x-\frac{x^3}{3!}+\frac{x^5}{5!}+\cdots \\
\end{align*}
